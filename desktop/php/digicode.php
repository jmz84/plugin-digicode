            ...
            <div role="tabpanel" class="tab-pane active" id="eqlogictab">
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <label class="col-sm-4 control-label">{{Statut de l'alarme}}</label>
                        <div class="col-sm-6">
                        ...
                        <label class="col-sm-4 control-label">{{Activation mode total}}</label>
                        <div class="col-sm-6">
                            <div class="input-group">
                        ...
                        <label class="col-sm-4 control-label">{{Activation mode Partiel}}</label>
                        <div class="col-sm-6">
                            <div class="input-group">
                        ...
                        <label class="col-sm-4 control-label">{{Désactivation alarme}}</label>
                        <div class="col-sm-6">
                            <div class="input-group">
                        ...
                        <label class="col-sm-4 control-label">{{Etat des portes}}</label>
                        <div class="col-sm-6">
                            <div class="input-group">
